  ...
  return (
    <div>
      <Flex gap={4} className={styles.btns}>
        ...
        <Button type={'text'} size={'small'}>Ordered</Button>
        <Button type={'text'} size={'small'}>Partial Received</Button>
        <Button type={'text'} size={'small'}>Received</Button>
        <Button type={'text'} size={'small'}>Closed</Button>
      </Flex>
      <div className={'line'} style={{ margin: '8px 0' }} />
      <Flex style={{ margin: '8px 12px' }} align={'center'} justify={'space-between'}>
